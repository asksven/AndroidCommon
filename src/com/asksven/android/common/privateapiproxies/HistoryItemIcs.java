...
public class HistoryItemIcs extends HistoryItem implements Serializable, Parcelable {
    ...
    public boolean isCharging() {
        return (m_statesValue & STATE_BATTERY_PLUGGED_FLAG) != 0;
    }
    ...
    public boolean isScreenOn() {
        return (m_statesValue & STATE_SCREEN_ON_FLAG) != 0;
    }
    ...
    public boolean isGpsOn() {
        return (m_statesValue & STATE_GPS_ON_FLAG) != 0;
    }
    ...
    public boolean isWifiRunning() {
        return (m_statesValue & STATE_WIFI_RUNNING_FLAG) != 0;
    }
    ...
    public boolean isWakeLock() {
        return (m_statesValue & STATE_WAKE_LOCK_FLAG) != 0;
    }
    ...
    public boolean isPhoneInCall() {
        return (m_statesValue & STATE_PHONE_IN_CALL_FLAG) != 0;
    }
    ...
    public boolean isPhoneScanning() {
        return (m_statesValue & STATE_PHONE_SCANNING_FLAG) != 0;
    }
    ...
    public boolean isBluetoothOn() {
        return (m_statesValue & STATE_BLUETOOTH_ON_FLAG) != 0;
    }
}
