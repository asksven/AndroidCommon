 ...
 *
 */
public class HistoryItemLPreview extends HistoryItem implements Serializable, Parcelable
{
    ...
    public HistoryItemLPreview(Long time, Byte cmd, Byte batteryLevel, Byte batteryStatusValue,
