...
public class Alarm extends StatElement implements Comparable<Alarm>, Serializable {
    ...
    public String getDetailedData() {
        ...
        for (AlarmItem m_item : m_items) {
            strRet += "  " + m_item.getData() + "\n";
        }
            ...
            for (StatElement aMyList : myList) {
                try {
                    ...
                    if (this.getName().equals(myRef.getName())) {
                        ...
                        // and process items
                        for (AlarmItem myItem : this.m_items) {
    ...
    public class AlarmItem implements Serializable {
        ...
        public void substractFromRef(List<AlarmItem> myList) {
            if (myList != null) {
                for (AlarmItem aMyList : myList) {
                    try {
                        AlarmItem myRef = (AlarmItem) aMyList;
